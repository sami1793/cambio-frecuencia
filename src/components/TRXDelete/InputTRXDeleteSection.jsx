...
export const InputTRXDeleteSection = ({
  ...
  const setBcfBts = (numberInput) => {
    setValues({
      ...
      dch1: "T" + toEXA(numberInput) + 1,
      dch2: "T" + toEXA(numberInput) + 2,
      dch3: "T" + toEXA(numberInput) + 3,
      dch4: "T" + toEXA(numberInput) + 4,
      dch5: "T" + toEXA(numberInput) + 5,
      dch6: "T" + toEXA(numberInput) + 6,
      dch7: "T" + toEXA(numberInput) + 7,
      dch8: "T" + toEXA(numberInput) + 8,
      dch9: "T" + toEXA(numberInput) + 9,
      dch10: "T" + toEXA(numberInput) + "A",
      dch11: "T" + toEXA(numberInput) + "B",
      dch12: "T" + toEXA(numberInput) + "C",
    });
  };
